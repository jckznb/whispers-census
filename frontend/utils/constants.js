...
export const CONTEXTS = [
  {
    ...
    phase: 1,
    summary: "A broad sample of the WoW playerbase from the ten highest-population US realms — Illidan, Area 52, Mal'Ganis, Zul'jin, Tichondrius, Stormrage, Sargeras, Thrall, Ragnaros, and Azralon. Guild roster crawl, not limited to rated content.",
    detail: "Characters were discovered by crawling guild rosters on the ten highest-population general US realms. Only max-level (80+) characters are counted. Race and class data comes from the guild roster API; spec data is NULL unless a character also appeared on a PvP or M+ leaderboard.",
    caveat: 'US region only. Covers only the 10 seeded high-pop realms — not all US realms. Guild roster data may lag behind character transfers or name changes. Spec breakdown is unavailable for most general population characters.',
  },
  {
    id: 'rp',
    label: 'RP Realms',
    phase: 1,
    summary: 'Guild roster census from the three largest US RP realms — Moon Guard, Wyrmrest Accord, and Emerald Dream. Reflects the distinct race and class preferences of the RP community.',
    detail: 'Characters were discovered by crawling guild rosters on Moon Guard, Wyrmrest Accord, and Emerald Dream — the three highest-population RP realms in the US. Seeded from a curated list of the top mythic-progression guilds per realm, then snowballed into the broader guild graph. Only max-level (80+) characters are counted.',
    caveat: 'US region only. RP realm demographics skew heavily toward aesthetically-motivated race choices rather than meta optimization. Spec breakdown is unavailable for most characters.',
  },
  {
    id: 'pvp',
    label: 'All PvP',
...
export const VALID_COMBOS = new Set([
  ...
  'Night Elf|Rogue', 'Night Elf|Warlock', 'Night Elf|Warrior',
  // Gnome
  ...
  'Draenei|Paladin', 'Draenei|Priest', 'Draenei|Rogue', 'Draenei|Shaman',
  'Draenei|Warlock', 'Draenei|Warrior',
  // Worgen
  'Worgen|Death Knight', 'Worgen|Druid', 'Worgen|Hunter', 'Worgen|Mage',
  'Worgen|Monk', 'Worgen|Priest', 'Worgen|Rogue', 'Worgen|Warlock', 'Worgen|Warrior',
  // Void Elf
  'Void Elf|Death Knight', 'Void Elf|Demon Hunter', 'Void Elf|Hunter',
  'Void Elf|Mage', 'Void Elf|Monk', 'Void Elf|Priest', 'Void Elf|Rogue',
  'Void Elf|Warlock', 'Void Elf|Warrior',
  // Lightforged Draenei
  'Lightforged Draenei|Death Knight', 'Lightforged Draenei|Hunter',
  'Lightforged Draenei|Mage', 'Lightforged Draenei|Monk',
  'Lightforged Draenei|Paladin', 'Lightforged Draenei|Priest',
  'Lightforged Draenei|Rogue', 'Lightforged Draenei|Warlock',
  ...
  'Kul Tiran|Shaman', 'Kul Tiran|Warlock', 'Kul Tiran|Warrior',
  // Mechagnome
  ...
  // Orc
  'Orc|Death Knight', 'Orc|Hunter', 'Orc|Mage', 'Orc|Monk', 'Orc|Priest',
  'Orc|Rogue', 'Orc|Shaman', 'Orc|Warlock', 'Orc|Warrior',
  // Undead
  'Undead|Death Knight', 'Undead|Hunter', 'Undead|Mage', 'Undead|Monk',
  'Undead|Priest', 'Undead|Rogue', 'Undead|Warlock', 'Undead|Warrior',
  // Tauren
  'Tauren|Death Knight', 'Tauren|Druid', 'Tauren|Hunter', 'Tauren|Mage',
  'Tauren|Monk', 'Tauren|Paladin', 'Tauren|Priest', 'Tauren|Rogue',
  'Tauren|Shaman', 'Tauren|Warlock', 'Tauren|Warrior',
  // Troll
  ...
  'Highmountain Tauren|Hunter', 'Highmountain Tauren|Mage',
  'Highmountain Tauren|Monk', 'Highmountain Tauren|Priest',
  'Highmountain Tauren|Rogue', 'Highmountain Tauren|Shaman',
  'Highmountain Tauren|Warlock', 'Highmountain Tauren|Warrior',
  // Mag'har Orc
  "Mag'har Orc|Death Knight", "Mag'har Orc|Hunter", "Mag'har Orc|Mage",
  "Mag'har Orc|Monk", "Mag'har Orc|Priest", "Mag'har Orc|Rogue",
  "Mag'har Orc|Shaman", "Mag'har Orc|Warlock", "Mag'har Orc|Warrior",
  // Zandalari Troll
  ...
  'Zandalari Troll|Shaman', 'Zandalari Troll|Warlock', 'Zandalari Troll|Warrior',
  // Vulpera
  ...
  'Pandaren|Priest', 'Pandaren|Rogue', 'Pandaren|Shaman', 'Pandaren|Warlock',
  'Pandaren|Warrior',
  // Dracthyr
  'Dracthyr|Evoker', 'Dracthyr|Hunter', 'Dracthyr|Mage', 'Dracthyr|Priest',
  'Dracthyr|Rogue', 'Dracthyr|Warlock', 'Dracthyr|Warrior',
  // Earthen
  ...
  // Haranir (neutral — both factions; added TWW 11.1)
  'Haranir|Druid', 'Haranir|Hunter', 'Haranir|Mage', 'Haranir|Monk',
  'Haranir|Priest', 'Haranir|Rogue', 'Haranir|Shaman', 'Haranir|Warlock',
  'Haranir|Warrior',
])
